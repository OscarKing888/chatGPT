# PPTX文件切分工具
```bash
python .\split_pptx.py "XXX.pptx" "." --page-ranges="1-7,8-17,18-25,26-27,28-30,31-32,33-39,40-49,50-57,58-61,62-66,67-69,70-77,78-87,88-96,97-100,101-107,108-128"
```
